...
Esta disciplina <b>será ministrada em breve</b>. O plano de ensino e os materiais 
didáticos ainda estão em desenvolvimento. O conteúdo apresentado aqui pode sofrer 
alterações ao longo do semestre.
</aside>

## Ementa

Introdução à programação competitiva. Problemas *ad-hoc* e de simulação. Algoritmos de
teoria dos números. Algoritmos gulosos. Estruturas da STL do C++. Árvore de Fenwick e
árvore de segmentos. Buscas em grafos. Árvores geradoras mínimas. Caminhos mínimos em
grafos. Programação dinâmica. Algoritmos em strings. Fluxo e emparelhamentos em grafos.
Geometria computacional. Teoria dos jogos.
