...
The [LPPC Discord]({{ site.data.lppc.links.discord }}) is the main channel for discussions, questions, links, resources, and track organization. Technical conversations and study follow-up should be concentrated there.

The [LPPC WhatsApp group]({{ site.data.lppc.links.whatsapp }}) is used for quick announcements about meetings, time changes, places, and urgent information. For longer discussions, use Discord.

## First Steps

1. Read the [Code of Conduct](/en/lppc/code-of-conduct/).
2. Join the [Discord]({{ site.data.lppc.links.discord }}).
3. Follow announcements through [WhatsApp]({{ site.data.lppc.links.whatsapp }}).
4. See the [meetings](/en/lppc/meetings/) page and participate in the next activity.
5. Choose a [track](/en/lppc/tracks/) and use the [resources](/en/lppc/resources/) consistently.
