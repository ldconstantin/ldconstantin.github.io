---
lang: pt
ref: lppc-for-educational-institutions
layout: single
title: "Para instituições de ensino"
permalink: /lppc/para-instituicoes-de-ensino/
...
Instituições de ensino também podem sediar encontros mediante disponibilidade, autorização e organização prévia. A cessão de espaço não precisa representar parceria formal; pode ser apenas uma forma concreta de apoiar uma atividade educacional aberta.

A LPPC pode contribuir para a formação de talentos, a melhoria do raciocínio lógico-matemático e a preparação de equipes para competições como OBI, Maratona SBC de Programação e MFP. Esses resultados dependem de continuidade, estudo regular e participação responsável.

## Formas de incentivo

- Divulgar a LPPC para estudantes e professores.
- Incentivar a formação de equipes para competições.
- Sediar encontros quando houver disponibilidade.
